...
// export let playerRewindDuration = 2; // how long the player is allowed to rewind in seconds.
...
//     if (rewind === true) {
//       if (gamehistory.stack.length > 0 && playerRewindDuration > 0) {
//         pop = gamehistory.pop();
//         player = pop[0];
//         surfacearray = pop[1];
